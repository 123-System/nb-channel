...
// ==========================================================
// 页脚标准化：旧版页面底部的版权小字统一为同一格式
// （新版页面已用 site-footer，此处只处理含"© 2026"的旧版 p 组）
// ==========================================================
(function () {
    var UNIFIED_FOOTER =
        '<div style="margin-top:20px; text-align:center; font-size:0.85rem; color:var(--count-text); line-height:2.1;">' +
        '© 2026 NB频道 · 虚拟公司 · <a href="https://nb-channel.top" target="_blank" rel="noopener noreferrer">nb-channel.top（导航页）</a> · ' +
        '<a href="https://github.nb-channel.top" target="_blank" rel="noopener noreferrer">github站</a> · ' +
        '<a href="https://cloudflare.nb-channel.top" target="_blank" rel="noopener noreferrer">cloudflare站</a> · ' +
        '<a href="https://pythonanywhere.nb-channel.top" target="_blank" rel="noopener noreferrer">pythonanywhere站</a><br>' +
        ...
        '托管：<a href="https://github.com/" target="_blank" rel="noopener noreferrer">Github</a> · ' +
        '<a href="https://www.cloudflare-cn.com/developer-platform/products/pages/" target="_blank" rel="noopener noreferrer">Cloudflare</a> · ' +
    ...
    function normalizeFooter() {
        ...
        for (var i = 0; i < ps.length; i++) {
            if (ps[i].textContent.indexOf('© 2026') !== -1) { start = ps[i]; break; }
        }
        if (!start) return;
        var nodes = [start];
